...
- **WHEN** um desenvolvedor ou agente de IA consultar e utilizar `docs/generic-golang-foundation-spec-prompt.md`
- **THEN** o documento deve fornecer um prompt parametrizável e agnóstico de frameworks web/CLI específicos, permitindo definir a stack desejada (Web, API, CLI, Daemon, Library) via placeholders enquanto mantém obrigatórios os pilares de Clean Architecture, TDD/BDD >= 80%, Makefile, Harness/Loop/Graph Engineering, CI/CD e governança OpenSpec/Git
