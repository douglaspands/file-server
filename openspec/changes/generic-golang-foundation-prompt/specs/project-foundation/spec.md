...
- **THEN** o documento deve fornecer um prompt parametrizável e agnóstico de frameworks web/CLI específicos, sem imposições pré-moldadas de empacotamento ou live-reload (Pilar 5), com diretrizes estruturadas de governança OpenSpec para fácil entendimento de regras de negócio por PO e automação de testes por QA (Pilar 7), mantendo obrigatórios os pilares de Clean Architecture, TDD/BDD >= 80%, Makefile, Harness/Loop/Graph Engineering, CI/CD e governança Git com Squash
