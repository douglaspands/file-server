---
name: opsx-sync
description: Sync delta specs from an OpenSpec change to main specs (/opsx-sync or /opsx:sync). Use when the user wants to update main specs with changes from a delta spec without archiving the change.
