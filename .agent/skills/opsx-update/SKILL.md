---
name: opsx-update
description: Update an OpenSpec change (/opsx-update or /opsx:update) by revising its existing planning artifacts and keeping them coherent with one another. Never edits code.
