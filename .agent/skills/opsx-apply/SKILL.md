---
name: opsx-apply
description: Implement tasks from an OpenSpec change (/opsx-apply or /opsx:apply). Use when the user wants to start implementing, continue implementation, or work through tasks.
