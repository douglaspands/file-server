---
name: opsx-archive
description: Archive a completed OpenSpec change and update main specs (/opsx-archive or /opsx:archive). Use when the user wants to finalize and archive a change after implementation is complete.
