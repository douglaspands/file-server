---
name: opsx-propose
description: Propose a new OpenSpec change with all artifacts generated in one step (/opsx-propose or /opsx:propose). Use when the user wants to quickly describe what they want to build and get a complete proposal with design, specs, and tasks ready for implementation.
